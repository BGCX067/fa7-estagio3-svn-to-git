...
class CategoriaController {
	...
	def save() {
		...
		categoriaInstance.imagem = uploadedFile.getBytes()
	...
	def show_imagem = {
		...
		response.setContentLength(categoriaInstance.imagem.size())
		OutputStream out = response.getOutputStream()
		out.write(categoriaInstance.imagem)
		out.close()
	}
	...
	def update(Long id, Long version) {
		...
		if(uploadedFile.empty){
			categoriaInstance.nome = params.nome
		} else {
