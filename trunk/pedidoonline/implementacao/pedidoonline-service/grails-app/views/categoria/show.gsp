...
<body>
	<a href="#show-categoria" class="skip" tabindex="-1"><g:message
	...
	<div id="show-categoria" class="content scaffold-show" role="main">
			...
			<g:if test="${categoriaInstance?.nome}">
				<li class="fieldcontain"><span id="nome-label"
					class="property-label"><g:message
							code="categoria.nome.label" default="Nome" /></span> <span
					class="property-value" aria-labelledby="nome-label"><g:fieldValue
							bean="${categoriaInstance}" field="nome" /></span></li>
			</g:if>

			<g:if test="${categoriaInstance?.imagem}">
				<li class="fieldcontain"><span id="imagem-label"
					class="property-label"><g:message
							code="categoria.imagem.label" default="Imagem" /></span> <span
					class="property-value" aria-labelledby="imagem-label"><img
						class="imagem"
		...
		<g:form>
			<fieldset class="buttons">
				...
				<g:link class="edit" action="edit" id="${categoriaInstance?.id}">
