			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="codigo" title="${message(code: 'area.codigo.label', default: 'Codigo')}" />
				...
				<g:each in="${areaInstanceList}" status="i" var="areaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${areaInstance.id}">${fieldValue(bean: areaInstance, field: "codigo")}</g:link></td>
